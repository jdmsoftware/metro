...
$groupTitles = array('Home','Support'); // titles of the tileGroups
$groupSpacing = array(5,4); // width of each tileGroup (spacing between the groups in tiles)
...
$bgImage = "img/bg/blue.png"; // background image, leave blank if you dont want one. It is recommend to keep the filesize to a minimum and also, if possible, use a low resolution
