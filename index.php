...
<head>
    ...
    <meta name="viewport" content="width=300, target-densitydpi=150, initial-scale=1">
...
<div id="wrapper">
	<div id="centerWrapper">
    	...
    	<div id="tileContainer" 
        	...
        	<img id='arrowLeft' class="navArrows" src='themes/<?php echo $theme?>/img/primary/arrowLeft.png' onClick="javascript:$group.goLeft();"/>
            <img id='arrowRight' class="navArrows" src='themes/<?php echo $theme?>/img/primary/arrowRight.png' onClick="javascript:$group.goRight();"/>
       		<?php 
